...
<div class="mainContainer">
	...
	<div class="rightCol">
		...
		<div class="hoursBox">
			...
			<div class="creditCards">(Sorry, we don't accept credit cards)</div>
		</div>
...
<script type="text/javascript">
	...
	var editLovin = {
		...
		clearSections : function() {
			$('#breakfastContainer, #breakfastMenuContainer, #lunchContainer, #lunchMenuContainer, #cafeContainer, #dinnerContainer, #dinnerMenuContainer, #homepageContainer, #hoursContainer').css('display', 'none');	
		}
	};
